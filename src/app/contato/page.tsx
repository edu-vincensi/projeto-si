...
export default function Contato() {
  return (
    <section id="contato" className="max-w-4xl mx-auto my-12 bg-white p-8 rounded-2xl shadow-lg">
      <h2 className="text-2xl font-semibold text-lime-600 mb-4">Fale Conosco</h2>
      ...
      <form className="space-y-4">
        ...
        <button
          type="submit"
          className="bg-lime-600 text-white px-6 py-2 rounded-lg shadow hover:bg-blue-700 transition-colors duration-300"
        >
          Enviar
        </button>
      </form>
